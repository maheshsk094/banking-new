...
public class CreateAc {
	...
	//	s.selectByVisibleText(sh.getRow(1).getCell(13).toString());
		...
		driver.findElement(By.name("pan")).sendKeys(eLib.readDataFronExcelFile("Sheet1", 1, 4));
		Thread.sleep(1000);
		driver.findElement(By.name("mob")).sendKeys(eLib.readDataFronExcelFile("Sheet1", 1, 1));//to enter numeric value
		Thread.sleep(1000);

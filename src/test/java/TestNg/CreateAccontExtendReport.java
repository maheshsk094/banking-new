...
@Listeners(com.BANKDOM_1.GenericUtility.ExtentReportImplementationClass.class)   //its for screenshot(copy qualified path from ListenerImplementaionClass select and right click on className and copy as qualified path)
public class CreateAccontExtendReport extends BaseClass {
